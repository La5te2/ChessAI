...
inline constexpr const char *kMoveEncoding =
	"side_relative_king_file_canonical_sd_64x64_underpromo9";
...
/// Encodes a legal move in the side-relative, king-file-canonical Policy frame.
int move_to_index(const chess::Move &move, const chess::Board &board);
/// Encodes a move when the Policy frame has already been determined by an accumulator.
