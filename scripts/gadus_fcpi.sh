...
COUNTERFACTUAL_TOPK="${COUNTERFACTUAL_TOPK:-6}"
COUNTERFACTUAL_REPLY_TOPK="${COUNTERFACTUAL_REPLY_TOPK:-4}"
COUNTERFACTUAL_REPLY_TEMPERATURE="${COUNTERFACTUAL_REPLY_TEMPERATURE:-0.20}"
COUNTERFACTUAL_MIN_PLIES="${COUNTERFACTUAL_MIN_PLIES:-2}"
COUNTERFACTUAL_MAX_PLIES="${COUNTERFACTUAL_MAX_PLIES:-6}"
COUNTERFACTUAL_TARGET_AVERAGE_PLIES="${COUNTERFACTUAL_TARGET_AVERAGE_PLIES:-4}"
COUNTERFACTUAL_LAMBDA="${COUNTERFACTUAL_LAMBDA:-0.80}"
TD_LAMBDA="${TD_LAMBDA:-0.80}"

BEHAVIOR_TEMPERATURE="${BEHAVIOR_TEMPERATURE:-1.0}"
UNIFORM_MIX="${UNIFORM_MIX:-0.03}"
POLICY_TEMPERATURE="${POLICY_TEMPERATURE:-0.25}"
PRIOR_POWER="${PRIOR_POWER:-1.0}"
PLAYED_RETURN_WEIGHT="${PLAYED_RETURN_WEIGHT:-0.50}"
...
COMMAND=(
	...
	--counterfactual-reply-topk "${COUNTERFACTUAL_REPLY_TOPK}"
	--counterfactual-reply-temperature "${COUNTERFACTUAL_REPLY_TEMPERATURE}"
...
echo "counterfactual: topk=${COUNTERFACTUAL_TOPK} reply_topk=${COUNTERFACTUAL_REPLY_TOPK} depth=${COUNTERFACTUAL_MIN_PLIES}-${COUNTERFACTUAL_MAX_PLIES}"
