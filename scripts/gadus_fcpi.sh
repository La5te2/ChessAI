...
STARTPOS_FRACTION="${STARTPOS_FRACTION:-0.20}"
...
OPPONENT_REPLY_TOPK="${OPPONENT_REPLY_TOPK:-4}"
OPPONENT_REPLY_TEMPERATURE="${OPPONENT_REPLY_TEMPERATURE:-0.20}"
...
COMMAND=(
	...
	--opponent-reply-topk "${OPPONENT_REPLY_TOPK}"
	--opponent-reply-temperature "${OPPONENT_REPLY_TEMPERATURE}"
