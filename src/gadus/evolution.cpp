...
// expanded decision node into a Policy sample. Only real self-play roots supervise Value.
...
// Fine-tune Policy on every expanded tree node and Value only on real self-play roots.
