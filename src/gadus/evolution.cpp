...
// Improve a local policy from frozen-model priors and backed action values. The
// maximum absolute local advantage bounds one update's log-odds shift to [-1, 1].
